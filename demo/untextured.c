...
int         demoMap[] = {
    GREEN, GREEN, PURPLE, PURPLE, PURPLE, PURPLE, PURPLE, PURPLE, PURPLE, PURPLE, BLUE,  -1,
    -1,    -1,    -1,     -1,     -1,     -1,     -1,     BLUE,   BLUE,   PURPLE, BLUE,  BLUE,
    BLUE,  BLUE,  BLUE,   BLUE,   -1,     BLUE,   PURPLE, -1,     -1,     -1,     -1,    -1,
    -1,    -1,    -1,     BLUE,   PURPLE, -1,     GREEN,  GREEN,  GREEN,  GREEN,  GREEN, -1,
    -1,    BLUE,  PURPLE, -1,     -1,     -1,     -1,     -1,     -1,     -1,     -1,    BLUE,
...
int main(int argc, char* argv[]) {
    ...
    while ((opt = getopt(argc, argv, "w:h:f:b:v")) != -1) {
        ...
        case 'h':
            ...
            break;
        case 'f':
            fg = (int) strtol(optarg, NULL, 16);
            break;
        case 'b':
            bg = (int) strtol(optarg, NULL, 16);
            break;
        case 'v':
            printf("libraycast %s\n", raycast_version());
            return 0;
        default:
            fprintf(
                stderr,
                "Usage: %s [-w width] [-h height] [-f foreground_color] [-b background_color]\n",
                argv[0]);
            exit(EXIT_FAILURE);
        }
    }
